...
\includeonly{
                ...
                Capitulos/11.Acronimos,
                Capitulos/12.Agradecimientos,
...
\includepdf[]{PDF/Portada_TFG_IngenieriaInformatica_DKH}
...
% \includepdf[]{PDF/Portada_TFG_IngenieriaInformatica_FIRMADO}
\includepdf[]{PDF/Portada_TFG_IngenieriaInformatica_DKH}
%Esta función incluye el PDF de la portada correspondiente al TFG. Dicho documento PDF ha de estar cargado en el menú de la izquierda como se encuentra esta portada auxiliar. Es importante incluir en el parámetro obligatorio la dirección a dicho PDF con su normbre correspondiente.
...
\include{Capitulos/2.AntecedentesJustificacion}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage

\include{Capitulos/3.Objetivos_y_Alcance}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage

\include{Capitulos/4.ConsideracionesEticas}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage
...
\include{Capitulos/6.Planificacion}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage

\include{Capitulos/7.IntroduccionFedLearn}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage

\include{Capitulos/8.0.Desarrollo}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage

\include{Capitulos/9.Presupuesto}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage

\include{Capitulos/10.Conclusiones}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage
...
\include{Capitulos/11.Acronimos}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage
...
\include{Capitulos/12.Agradecimientos}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage
...
\include{Anexos/1.AnexoProteccionDatos}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage

\include{Anexos/2.AnexoDocs}
\fancyhead[LE]{}
\newpage
\thispagestyle{empty}
\cleardoublepage

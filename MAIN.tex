...
\includepdf{PDF/Blanco}
%Esta función permite introducir un pdf entre medias del documento o en cualquier momento que sea necesario. Así, el pdf utilizado en este caso es una página en blanco pero como se habrá observado puede servir para incluir la portada del proyecto, algún manual de instrucciones o cualquier archivo pdf que se desee. El argumento obligatorio debe contener el nombre del archivo y su dirección (en caso de que esté en el interior de alguna carpeta).
...
\include{Chapters/3.Objetivos_y_Alcance}
...
\include{Algorithms/ConsensoMath}
